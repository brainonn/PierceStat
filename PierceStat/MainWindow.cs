...
namespace PierceStat
{
    public partial class Form_MainWindow : Form
    {
        public Form_MainWindow()
        {
            ...
            comboBox_ComPortsList.Enabled = true; //re-enable com-port selection
        ...
        private void comboBox_ComPortsList_SelectedIndexChanged(object sender, EventArgs e)
        {
        ...
        private void flowLayoutDataTable_Paint(object sender, PaintEventArgs e)
        {

        }

        private void groupBox_Channel2_Enter(object sender, EventArgs e)
        {
